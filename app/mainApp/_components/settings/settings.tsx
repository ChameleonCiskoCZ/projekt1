...
const Settings: React.FC<UserInfo> = ({ ownerUsername, workspaceId }) => {
  ...
  const [removeCardPermission, setRemoveCardPermission] = useState(false);
  ...
  const handleCreateRole = async () => {
    ...
    await setDoc(roleRef, { name: newRoleName, moveCard: false, removeCard: false});
    setNewRoleName("");
  };
  ...
  const handleToggleRemoveCardPermission = async () => {
    if (selectedRole) {
      const updatedPermission = !removeCardPermission;
      setRemoveCardPermission(updatedPermission);
      const roleRef = doc(
        db,
        "users",
        ownerUsername,
      ...
      await updateDoc(roleRef, { removeCard: updatedPermission });
    }
    };
                  ...
                  <div className="w-1/2 flex flex-col pl-5">
                    ...
                    <div className="flex flex-col items-stretch space-y-2">
                      ...
                      <div className="flex items-center justify-between space-x-2">
                        ...
                        <Switch
                          onChange={handleToggleRemoveCardPermission}
                          checked={removeCardPermission}
                          offColor="#767577"
                          onColor="#81b0ff"
                          height={20}
                          width={48}
